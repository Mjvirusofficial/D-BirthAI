...
const Login = () => {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            if (!response.ok) {
                throw new Error(data.msg || 'Google Login failed on server');
            }
        ...
        <div className="min-h-screen bg-white flex flex-col items-center justify-center relative overflow-hidden font-sans p-6">
            ...
            <div className="relative z-10 w-full max-w-md flex flex-col items-center gap-6">
                ...
                {/* 
                  ...
                  Computer (Left) + Walker (Right) meet with confetti
                */}
                ...
                >
                    ...
                    <p className="text-gray-500 text-sm mb-6">Sign in to continue to D-BirthAI</p>
                    ...
                    <div className="flex items-center w-full mb-6">
                        ...
                        <span className="px-4 text-gray-400 text-xs font-medium uppercase tracking-wider">Or Login With Email</span>
                        <div className="flex-grow h-px bg-gray-200"></div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="w-full space-y-5">
                        ...
                        <div className="flex justify-end">
                            <Link to="/forgot-password" className="text-sm text-[#EC4899] font-bold hover:underline">
                                Forgot Password?
                            </Link>
                        </div>
                    ...
                    <div className="mt-8 text-center text-gray-500 text-sm">
                        ...
                        <Link to="/register" className="text-[#A855F7] font-bold hover:underline hover:text-[#9333ea]">
                            Sign Up
                        </Link>
                    </div>
                </motion.div>
